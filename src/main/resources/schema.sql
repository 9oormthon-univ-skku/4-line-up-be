...
create table area (id bigint AUTO_INCREMENT, name varchar(255) not null, summary varchar(255), x integer, y integer, open timestamp(6), close timestamp(6), status enum('ACTIVE', 'DELETED') not null, created_at timestamp(6) not null, updated_at timestamp(6) not null, primary key (id));
create table booth (id bigint AUTO_INCREMENT, area_id bigint, category_id bigint not null, dtype enum('BOOTH', 'STORE', 'GATE') not null, thumbnail varchar(255) not null, name varchar(255) not null, summary varchar(255), description text not null, x integer, y integer, open timestamp(6), close timestamp(6), gate_type enum ('ALL','ENTRY','EXIT'), status enum('ACTIVE', 'DELETED') not null, created_at timestamp(6) not null, updated_at timestamp(6) not null, primary key (id));
...
create table post (id bigint AUTO_INCREMENT, thumbnail varchar(255) not null, title varchar(255) not null, content text not null, status enum('ACTIVE', 'DELETED') not null, created_at timestamp(6) not null, updated_at timestamp(6) not null, primary key (id));
